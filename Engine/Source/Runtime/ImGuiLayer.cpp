...
bool ImGuiLayer::Initialize(GLFWwindow* window, VulkanContext* context)
{
...
void ImGuiLayer::CreateDescriptorPool()
{
    ...
    if (vkCreateDescriptorPool(vulkanContext->GetDevice(), &pool_info, nullptr, &descriptorPool) != VK_SUCCESS)
    {
